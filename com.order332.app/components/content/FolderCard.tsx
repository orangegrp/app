...
export function FolderCard({ folder, isCreatorMode, onOpen, onRename, onDelete }: FolderCardProps) {
  const [confirmOpen, setConfirmOpen] = useState(false)

  return (
    <>
      <div className="glass-card group relative flex cursor-pointer flex-col overflow-hidden rounded-xl">
        {/* Creator actions */}
        {isCreatorMode && (
