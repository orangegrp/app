...
function __ZN10__cxxabiv1L8do_throwEPNS_9ExceptionE(Larg0){
	...
	tmp2=new CheerpException(tmp3,!!0,0);
	Larg0.a0=tmp2;
	throw tmp2;
	;
}
...
function __ZN12_GLOBAL__N_119CheerpStringBuilder11processCharERjS1_h(Larg0,Marg0,Larg1){
	...
	a:if((Larg1&255)<192){
		if((L$psink|0)===0){
			if(Larg1<<24<=-16777216)___assert_fail(1070280|0,tmp0,90,tmp1);
			;
			__ZZN12_GLOBAL__N_117do_syscall_writevEPK5ioveclE9codepoint=tmp4;
		}else{
			if((tmp4&192|0)!==128)___assert_fail(1070388|0,tmp0,76,tmp1);
			;
		...
		if((L$psink|0)!==0)___assert_fail(1070264|0,tmp0,101,tmp1);
		;
		if((Larg1&255)<224){
			tmp2=31;
			L$psink=1;
...
export default function(tmp1){
	...
	{i:{
			...
			_testUseAtomicWaitJS:_testUseAtomicWaitJS,
			___cxa_uncaught_exceptions:___cxa_uncaught_exceptions,
			___cxa_throw_wasm_adapter:___cxa_throw_wasm_adapter,
			__ZN12_GLOBAL__N_111raiseSignalEi:__ZN12_GLOBAL__N_111raiseSignalEi,
