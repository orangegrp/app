...
function __ZN12_GLOBAL__N_119CheerpStringBuilder11processCharERjS1_h(Larg0,Marg0,Larg1){
	...
	a:if((Larg1&255)<192){
		if((L$psink|0)===0){
			if(Larg1<<24<=-16777216)___assert_fail(1070280|0,tmp1,90,tmp0);
			;
			__ZZN12_GLOBAL__N_117do_syscall_writevEPK5ioveclE9codepoint=tmp4;
		}else{
			if((tmp4&192|0)!==128)___assert_fail(1070388|0,tmp1,76,tmp0);
			;
		...
		if((L$psink|0)!==0)___assert_fail(1070264|0,tmp1,101,tmp0);
		;
		if((Larg1&255)<224){
			tmp2=31;
			L$psink=1;
